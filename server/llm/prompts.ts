        ...
        "text": `
          ...
          items[] - An array containing exactly one item with the following properties:
            ...
            skills[] - If the item seems like a tool that could be used on another item, this is an array of active crafting skills 
                      If the item is not a tool, this is an array of whacky passives
                      Each skill should be an object with "name" and "description".
                      "name" must be a verb-like action, performed against another entity.
                      Description should aim to be slightly corny and fun, in the spririt of a whacky D&D adventure
          `
      },
      {
        "cachePoint": {
